...
public class RoleRepositoryTest {
	...
	public void testCreateAllRoles() {
		Role roleSalePerson = new Role("Salesperson", "manage product price, customer, shipping, order");
		
		Role roleEditor = new Role("Editor", "manage categories, brands, products, menus..");
